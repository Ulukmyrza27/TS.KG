...
// указываем начальное состояние чтоб позже могли сохранить данные
const INIT_STATE = {
  videos: [],
  oneVideo: null,
};
// reducer - это функция которая будет менять INIT_STATE
// Action  - это объект с ключами type (то действие которое выполняется), payload (массив с данными)
// let action = {
//     type: 'value',
//     payload: 'data'
